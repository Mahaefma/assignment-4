...
class Bunny(Mammal, Herbivore, Pet):
    ...
    def sleep(self) -> str:
        print('Bunnies as nocturnal animals, typically sleep arounf 12 to 14 hours a day in short intermittent periods.')

    def eat(self) -> str:
        Herbivore.eat(self)
        print('I mostly eat fresh hay and grass with some leafy green and a few pellets. I should only be given\
              fruit and root vegetables, like carrots, as an occasional treat')
